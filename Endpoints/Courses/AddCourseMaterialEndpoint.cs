...
public sealed class AddCourseMaterialEndpoint : ApiEndpoint<AddCourseMaterialRequest, AddCourseMaterialResponse>
{
    private readonly ICourseService _courseService;
    private readonly ICurrentUserContext _currentUserContext;

    public AddCourseMaterialEndpoint(ICourseService courseService, ICurrentUserContext currentUserContext)
    {
    ...
    public override async Task HandleAsync(AddCourseMaterialRequest req, CancellationToken ct)
    {
        ...
        var result = await _courseService.AddCourseMaterialAsync(offeringId, userId.Value, req, ct);
        ...
        await SendSuccessAsync(result.Value, ct, "Material uploaded successfully");
    }
}
