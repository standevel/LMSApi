...
public interface IAssignmentService
{
    ...
    Task<ErrorOr<List<AssignmentDto>>> GetAssignmentsAsync(Guid? courseId, Guid? currentUserId = null, bool restrictToStudentEnrollments = false, CancellationToken ct = default);
